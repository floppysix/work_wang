...
vim /lib/systemd/system/ais_global_fuwuqi.service
#刷新配置
systemctl daemon-reload

#服务加入开机自启
systemctl enable ais_global_fuwuqi

#启动/关闭/重启 
systemctl start ais_global_fuwuqi
#查看状态
systemctl status ais_global_fuwuqi
...
User=root
Group=root
ExecStart=/bin/nohup /mnt/pest/module/jdk1.8.0_212/bin/java -jar /mnt/pest/module/AIS/ais_global_fuwuqi/aismessage_clickhouse.jar --spring.config.location=/mnt/pest/module/AIS/ais_global_fuwuqi/application.yml 
